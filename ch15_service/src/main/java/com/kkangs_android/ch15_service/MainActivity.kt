package com.kkangs_android.ch15_service
...
import com.kkangs_android.ch15_outer.IMyAIDLInterface
import com.kkangs_android.ch15_service.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    val messengerConnection : ServiceConnection = object : ServiceConnection {
        override fun onServiceConnected(name: ComponentName?, service: IBinder?) {
            Log.d("wonhui", "onServiceConnected")
        ...
        override fun onServiceDisconnected(name: ComponentName?) {
            Log.d("wonhui", "onServiceDisconnected")
        }
    }
    ...
    private fun onCreateMessengerService() {
        ...
        binding.messengerPlay.setOnClickListener {
            ...
            intent.setPackage("com.kkangs_android.ch15_outer")
    ...
    private fun onCreateJobScheduler(){
        val jobSceduler: JobScheduler? = getSystemService(JOB_SCHEDULER_SERVICE) as JobScheduler
